...
class AppColors {
  static const Color deepGreen = Color(0xFF1B5E20); // Dark green for gradient start
  static const Color lightGreen = Color(0xFFA5D6A7); // Light green for gradient end
